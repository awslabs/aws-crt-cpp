...
class BuildCrt(Builder.Action):
    ...
    def _transform_cmake_args(self, env, project, cmake_args):
        ...
        if (sys.platform.startswith("linux") or sys.platform.startswith("freebsd")):
            ...
            print ("Trying to install a SSL development library (either libssl-dev or openssl-devel)")
            ...
            try:
                ...
                try:
                    ...
                    print ("ERROR - could not install either libssl-devel or openssl-devel. Skipping setting '-DUSE_OPENSSL=ON'")
