...
{
    /*TODO - this will have to come from user code*/
    char *ntlm_response = get_ntlm_resp();
...
{
    /*TODO - this will have to come from user code*/
    char *ntlm_credential = get_ntlm_cred();
...
{
    /*TODO - move to user area*/
    send_kerberos_status(httpStatusCode);
