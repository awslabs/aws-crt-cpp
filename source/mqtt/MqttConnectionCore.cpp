...
namespace Aws
{
    namespace Crt
    {
        namespace Mqtt
        {
            void MqttConnectionCore::s_onConnectionInterrupted(aws_mqtt_client_connection *, int errorCode, void *userData)
            {
            ...
            void MqttConnectionCore::s_onConnectionFailure(aws_mqtt_client_connection *, int errorCode, void *userData)
            {
                auto connWrapper = reinterpret_cast<MqttConnectionCore *>(userData);
            ...
            void MqttConnectionCore::s_onDisconnect(aws_mqtt_client_connection *, void *userData)
            {
            ...
            void MqttConnection::s_onTermination(aws_mqtt_client_connection *, void *userData)
            {
                AWS_LOGF_DEBUG(AWS_LS_MQTT_CLIENT, "calling s_onTermination: %p", userData);
                ...
                const Io::SocketOptions &socketOptions)
            {
                ...
                if (self->m_underlyingConnection)
                {
                    ...
                    aws_mqtt_client_connection_set_termination_handler(
                        self->m_underlyingConnection, MqttConnectionCore::s_onTermination, self);
                }
            }
