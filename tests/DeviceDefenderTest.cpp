...
static int s_TestDeviceDefenderBuilderResourceSafety(Aws::Crt::Allocator *allocator, void *ctx)
{
    (void)ctx;
    {
        Aws::Crt::ApiHandle apiHandle(allocator);
...
AWS_TEST_CASE(DeviceDefenderBuilderResourceSafety, s_TestDeviceDefenderBuilderResourceSafety)
