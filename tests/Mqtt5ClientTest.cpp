...
/*
 * [MP-UC4] Manual PUBACK post-callback test: calling acquire_puback_control() after callback returns null.
 */
static int s_TestMqtt5ManualPubackAcquirePostCallbackReturnsNull(Aws::Crt::Allocator *allocator, void *)
{
    Mqtt5TestEnvVars mqtt5TestVars(allocator, MQTT5CONNECT_IOT_CORE);
    if (!mqtt5TestVars)
    {
