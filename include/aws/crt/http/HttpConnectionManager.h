...
namespace Aws
{
    namespace Crt
    {
        namespace Http
        {
            ...
            using HttpOnConnectionCreated = std::function<void(struct aws_http_connection *connection)>;
                ...
                : public std::enable_shared_from_this<HttpClientConnectionManager>
            {
              ...
              private:
                ...
                static void s_onConnectionCreated(aws_http_connection *connection, void *userData) noexcept;
