...
{
    template <class _CharT, class _Traits>
    struct hash<Aws::Crt::basic_string_view<_CharT, _Traits>>
        : public unary_function<Aws::Crt::basic_string_view<_CharT, _Traits>, size_t>
    {
        size_t operator()(const Aws::Crt::basic_string_view<_CharT, _Traits> __val) const noexcept;
    };

    template <class _CharT, class _Traits>
    size_t hash<Aws::Crt::basic_string_view<_CharT, _Traits>>::operator()(
        const Aws::Crt::basic_string_view<_CharT, _Traits> __val) const noexcept
    {
        return Aws::Crt::_Fnv1a_append_bytes(
            Aws::Crt::_FNV_offset_basis,
            reinterpret_cast<const unsigned char *>(__val.data()),
            __val.size() * sizeof(_CharT));
    }
} // namespace std
