...
namespace Aws
{
    namespace Crt
    {
        namespace Mqtt5
        {
             ...
             *
             * If the server allows topic aliasing, this setting controls how topic aliases are used on PUBLISH packets
             ...
             */
            using OutboundTopicAliasBehaviorType = aws_mqtt5_client_outbound_topic_alias_behavior_type;
             ...
             */
            using InboundTopicAliasBehaviorType = aws_mqtt5_client_inbound_topic_alias_behavior_type;
