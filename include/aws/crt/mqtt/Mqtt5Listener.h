...
namespace Aws
{
    namespace Crt
    {
        namespace Mqtt5
        {
             ...
             *
             * @return true if the message is handled, otherwise return false
             */
             ...
             */
            class AWS_CRT_CPP_API Mqtt5Listener
            {
              public:
                /**
                 ...
                 * @return a new mqtt5 listener, ScopedResource = std::unique_ptr<T, std::function<void(T *)>>;
                 */
                static ScopedResource<Mqtt5Listener> NewMqtt5Listener(
