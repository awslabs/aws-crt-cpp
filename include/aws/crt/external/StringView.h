...
template <typename _CharT, typename _Traits = std::char_traits<_CharT>> class basic_string_view
{
  public:
    ...
    size_type find(const _CharT *__str, size_type __pos, size_type __n) const noexcept
    {
        ...
        const _CharT *__r = _s_search_substring(_M_str + __pos, _M_str + _M_len, __str, __str + __n);
    ...
    size_type rfind(const _CharT *__str, size_type __pos, size_type __n) const noexcept
    {
        ...
        const _CharT *__r = _s_find_end(_M_str, _M_str + __pos, __str, __str + __n);
    ...
    size_type find_first_of(const _CharT *__str, size_type __pos, size_type __n) const noexcept
    {
        ...
        const _CharT *__r = _s_find_first_of_ce(_M_str + __pos, _M_str + _M_len, __str, __str + __n);
  ...
  private:
    ...
    static inline const _CharT *_s_search_substring(
    ...
    static const _CharT *_s_find_end(
        const _CharT *__first1,
        const _CharT *__last1,
        const _CharT *__first2,
        const _CharT *__last2)
    ...
    static const _CharT *_s_find_first_of_ce(
        const _CharT *__first1,
        const _CharT *__last1,
        const _CharT *__first2,
        const _CharT *__last2)
...
{
    template <class _CharT, class _Traits>
    struct hash<basic_string_view<_CharT, _Traits>> : public unary_function<basic_string_view<_CharT, _Traits>, size_t>
    {
    ...
    size_t hash<basic_string_view<_CharT, _Traits>>::operator()(const basic_string_view<_CharT, _Traits> __val) const
        noexcept
    {
        auto str = std::basic_string<_CharT, _Traits>(__val.data(), __val.size());
        return std::hash<std::basic_string<_CharT, _Traits>>()(str);
    }
} // namespace std
