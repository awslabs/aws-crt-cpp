...
\label{_host_resolver_8h_source}\index{/Users/dengket/project/crts/aws-\/crt-\/cpp/include/aws/crt/io/HostResolver.h@{/Users/dengket/project/crts/aws-\/crt-\/cpp/include/aws/crt/io/HostResolver.h}}
...
\DoxyCodeLine{7 }
\DoxyCodeLine{8 \textcolor{preprocessor}{\#include <aws/io/host\_resolver.h>}}
\DoxyCodeLine{9 }
...
\DoxyCodeLine{20 }
\DoxyCodeLine{21             \textcolor{keyword}{using} \mbox{\hyperlink{namespace_aws_1_1_crt_1_1_io_a74f2659525c59a6d43f579af6586a1ce}{HostAddress}} = aws\_host\_address;}
\DoxyCodeLine{22 }
...
\DoxyCodeLine{30 }
\DoxyCodeLine{31             \textcolor{keyword}{class }\mbox{\hyperlink{_exports_8h_a0a3f6c46aee6b588ce99a142cdb22d1d}{AWS\_CRT\_CPP\_API}} \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_host_resolver}{HostResolver}}}
\DoxyCodeLine{32             \{}
...
\DoxyCodeLine{36 }
\DoxyCodeLine{38                 \textcolor{keyword}{virtual} aws\_host\_resolver *GetUnderlyingHandle() noexcept = 0;}
\DoxyCodeLine{40                 virtual aws\_host\_resolution\_config *GetConfig() noexcept = 0;}
\DoxyCodeLine{41             \};}
\DoxyCodeLine{42 }
\DoxyCodeLine{43             class \mbox{\hyperlink{_exports_8h_a0a3f6c46aee6b588ce99a142cdb22d1d}{AWS\_CRT\_CPP\_API}} \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver}{DefaultHostResolver}} final : public \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_host_resolver}{HostResolver}}}
\DoxyCodeLine{44             \{}
...
\DoxyCodeLine{56                     \mbox{\hyperlink{namespace_aws_1_1_crt_a3c9efb213e2de565038afcfd4f8afcda}{Allocator}} *allocator = \mbox{\hyperlink{namespace_aws_1_1_crt_a7178ef65f261a8db52a624458331bbb2}{g\_allocator}}) \textcolor{keyword}{noexcept};}
...
\DoxyCodeLine{59                 \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver}{DefaultHostResolver}} \&\mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver_a36ec173a64d71d48f6e9d58b6e6ea974}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver}{DefaultHostResolver}} \&) = \textcolor{keyword}{delete};}
...
\DoxyCodeLine{61                 \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver}{DefaultHostResolver}} \&\mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver_a0cc495be955b0ff6d03bd6b18c9e6423}{operator=}}(\mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver}{DefaultHostResolver}} \&\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{62 }
\DoxyCodeLine{66                 \textcolor{keyword}{operator} bool() const noexcept \{ \textcolor{keywordflow}{return} m\_initialized; \}}
\DoxyCodeLine{70                 \textcolor{keywordtype}{int} \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_default_host_resolver_a9565cc5a541c28081416f05723276916}{LastError}}() const noexcept \{ \textcolor{keywordflow}{return} aws\_last\_error(); \}}
\DoxyCodeLine{71 }
...
\DoxyCodeLine{79 }
\DoxyCodeLine{81                 aws\_host\_resolver *GetUnderlyingHandle() noexcept\textcolor{keyword}{ override }\{ \textcolor{keywordflow}{return} m\_resolver; \}}
\DoxyCodeLine{83                 aws\_host\_resolution\_config *GetConfig() noexcept\textcolor{keyword}{ override }\{ \textcolor{keywordflow}{return} \&m\_config; \}}
\DoxyCodeLine{84 }
\DoxyCodeLine{85               \textcolor{keyword}{private}:}
\DoxyCodeLine{86                 aws\_host\_resolver *m\_resolver;}
\DoxyCodeLine{87                 aws\_host\_resolution\_config m\_config;}
...
\DoxyCodeLine{92                     \textcolor{keyword}{struct} aws\_host\_resolver *resolver,}
\DoxyCodeLine{93                     \textcolor{keyword}{const} \textcolor{keyword}{struct} aws\_string *host\_name,}
\DoxyCodeLine{94                     \textcolor{keywordtype}{int} err\_code,}
\DoxyCodeLine{95                     \textcolor{keyword}{const} \textcolor{keyword}{struct} aws\_array\_list *host\_addresses,}
